...
Accurate descriptions of fuel and vegetation are essential for wildland fire modeling \cite{loudermilk_vegetations_2022}, which is an integral aspect of land management planning \cite{drury_interagency_2016}, disaster mitigation \cite{staley_updated_2016}, and species conservation \cite{lucash_managing_2022}.
Prescribed burning is a key management practice for forests across the U.S. \cite{ryan_prescribed_2013} that utilizes fuel and fire modeling for prioritization, implementation and incident planning, and practitioner training.
For all of these purposes, fire modeling that accounts for 3D fuel structures, topography, and dynamic winds is poised to become an increasingly vital component for planning prescribed fire in high-priority landscapes \cite{parsons_going_2023, hiers_prescribed_2020}.

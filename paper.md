...
DUET was developed at the Los Alamos National Laboratory for creating inputs to physics-based 3D fire behavior models like FIRETEC [@Linn2002] and QUIC-Fire [@Linn2020].
...
1. The `InputFile` class manages the DUET input file. INPUT FILES ARE VALIDATED